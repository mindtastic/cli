...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		OperationServers: map[string]ServerConfigurations{
			...
			"AuthenticationApiService.InitUserRegistration": {
				{
					URL: "https://auth.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"AuthenticationApiService.SubmitUserLogin": {
				{
					URL: "https://auth.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"AuthenticationApiService.SubmitUserRegistration": {
				{
					URL: "https://auth.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"AuthenticationApiService.UserLogout": {
				{
					URL: "https://auth.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MoodDiaryServiceApiService.AddMood": {
				{
			...
			"MoodDiaryServiceApiService.DeleteMoodDiary": {
				{
					URL: "https://diary.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MoodDiaryServiceApiService.GetMoodDiary": {
				{
					URL: "https://diary.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MotivatorServiceApiService.DeleteMotivatorUserId": {
				{
			...
			"MotivatorServiceApiService.DeleteMotivatorUserIdResultMotivatorId": {
				{
					URL: "https://motivator.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MotivatorServiceApiService.GetMotivatorUserId": {
				{
					URL: "https://motivator.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MotivatorServiceApiService.GetSafetynet": {
				{
					URL: "https://motivator.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MotivatorServiceApiService.PostMotivatorUserId": {
				{
					URL: "https://motivator.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MotivatorServiceApiService.PostMotivatorUserIdFeedbackMotivatorId": {
				{
					URL: "https://motivator.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"MotivatorServiceApiService.SafetyNetPost": {
				{
					URL: "https://motivator.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.AdminCreateUser": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.AdminGetUser": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.DeleteUserData": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.DeleteUserSettings": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.GetUserData": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.GetUserSettings": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
			...
			"UserServiceApiService.PutUserData": {
				{
					URL: "https://users.api.{environment}.mindtastic.lol",
					Description: "No description provided",
					Variables: map[string]ServerVariable{
