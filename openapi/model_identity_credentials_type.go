...
const (
	PASSWORD IdentityCredentialsType = "password"
	TOTP IdentityCredentialsType = "totp"
	OIDC IdentityCredentialsType = "oidc"
	WEBAUTHN IdentityCredentialsType = "webauthn"
	LOOKUP_SECRET IdentityCredentialsType = "lookup_secret"
)
