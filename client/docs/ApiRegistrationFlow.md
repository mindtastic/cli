...
`func (o *ApiRegistrationFlow) SetActive(v IdentityCredentialsType)`
...
`func (o *ApiRegistrationFlow) GetIssuedAtOk() (*time.Time, bool)`
...
`func (o *ApiRegistrationFlow) GetType() string`
