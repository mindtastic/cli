...
// BrowserLoginFlow struct for BrowserLoginFlow
...
func (o BrowserLoginFlow) MarshalJSON() ([]byte, error) {
...
type NullableBrowserLoginFlow struct {
	value *BrowserLoginFlow
	isSet bool
}

func (v NullableBrowserLoginFlow) Get() *BrowserLoginFlow {
	return v.value
}

func (v *NullableBrowserLoginFlow) Set(val *BrowserLoginFlow) {
	v.value = val
	v.isSet = true
}

func (v NullableBrowserLoginFlow) IsSet() bool {
	return v.isSet
}

func (v *NullableBrowserLoginFlow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrowserLoginFlow(val *BrowserLoginFlow) *NullableBrowserLoginFlow {
	return &NullableBrowserLoginFlow{value: val, isSet: true}
}

func (v NullableBrowserLoginFlow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrowserLoginFlow) UnmarshalJSON(src []byte) error {
	v.isSet = true
